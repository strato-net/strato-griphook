...
| `includeTokens` | `boolean` | `false` | Fetch full token catalog (large response) |
| `includeStats` | `boolean` | `false` | Include token statistics |
| `includeEarningAssets` | `boolean` | `false` | Include earning assets |
| `includeBalances` | `boolean` | `false` | Include user balances |
...
| `includeStats` | `boolean` | `false` | Include CDP statistics |
...
| `includeSummary` | `boolean` | `false` | Include withdrawal summary |

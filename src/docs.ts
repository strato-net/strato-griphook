...
- Login requires OAUTH_CLIENT_ID, OAUTH_CLIENT_SECRET, and OPENID_DISCOVERY_URL.
- Once logged in, tokens are stored in ~/.griphook/credentials.json and refreshed automatically.
...
Authentication: Run 'griphook login' to authenticate via browser OAuth.

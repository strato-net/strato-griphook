 ...
 ╚═════╝ ╚═╝  ╚═╝╚═╝╚═╝     ╚═╝  ╚═╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═╝</div>
    ...
    <div class="panel">
      ...
      <div class="panel-body">
        ...
        <div class="tabs">
          <button class="tab active" onclick="showTab('cursor')">Cursor</button>
          <button class="tab" onclick="showTab('claude-code')">Claude Code</button>
  ...
  "mcpServers": {
    "griphook": {
      ...
      "headers": {
        ...
        <div id="claude-code" class="tab-content">
